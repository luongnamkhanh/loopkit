...
| Delivery: MR link sau approve | ⬜ ❗ | demanded live (ticket normalize_phone 2026-07-08): artifact mới chỉ post Slack + nằm trong worktree; lần này làm TAY: move file theo pattern repo → commit → push `feat/vn-phone-normalizer` → link create-MR từ output của push. Next build: tự động hoá đúng chuỗi đó sau approve, post MR link vào thread |
